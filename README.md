...
```
# Output Waveform
<img width="285" height="669" alt="image" src="https://github.com/user-attachments/assets/a6ab6032-f3da-4d6e-87f8-245f4631aa72" />

# Results
```
thus,a simple python program to Generate Matrix, Codeword, Hamming weight, Syndrome matrix and find the error on received codeword using Linear block code was verified.
```
